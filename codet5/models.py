...
def build_or_load_gen_model(args):
    ...
    if args.config_name and os.path.exists(args.model_name_or_path):
        if not os.path.exists(args.model_name_or_path + '/config.json'):
            config.save_pretrained(args.model_name_or_path)
