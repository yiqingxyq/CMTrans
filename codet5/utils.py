...
def get_filenames(data_root, task, sub_task, split=''):
    if task == 'concode':
        ...
        elif sub_task in ['cpp-java', 'java-cpp']:
            src, tgt = sub_task.split('-')
            train_fn = '{}/train.cpp-java.{},{}/train.cpp-java.{}'.format(data_root, src, data_root, tgt)
            dev_fn = '{}/valid.cpp-java.{},{}/valid.cpp-java.{}'.format(data_root, src, data_root, tgt)
            test_fn = '{}/test.cpp-java.{},{}/test.cpp-java.{}'.format(data_root, src, data_root, tgt)
        elif sub_task in ['cpp-python', 'python-cpp']:
            src, tgt = sub_task.split('-')
            train_fn = '{}/train.cpp-python.{},{}/train.cpp-python.{}'.format(data_root, src, data_root, tgt)
            dev_fn = '{}/valid.cpp-python.{},{}/valid.cpp-python.{}'.format(data_root, src, data_root, tgt)
            test_fn = '{}/test.cpp-python.{},{}/test.cpp-python.{}'.format(data_root, src, data_root, tgt)
        else:
            data_dir = '{}/{}'.format(data_root, task)
            if sub_task == 'cs-java':
