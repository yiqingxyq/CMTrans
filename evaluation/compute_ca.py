...
EVAL_SCRIPT_FOLDER = {
    ...
    "humanevalx": "../data/humanEvalX_evaluation"
}
...
def main(params):
    ...
    if params.dataset == 'transcoder':
        eval_script_folder = EVAL_SCRIPT_FOLDER[params.split]
    elif params.dataset == 'humanevalx':
        eval_script_folder = EVAL_SCRIPT_FOLDER['humanevalx']
    ...
    for beam_number in range(len(success_for_beam_number)):
        ...
        #     beam_number
        # )
        out_name = "hyp.{0}_beam{1}.out.txt".format(
            params.out_prefix,
            beam_number
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_prefix", type=str, default="java-python.test")
    parser.add_argument("--dataset", type=str, default="transcoder")
